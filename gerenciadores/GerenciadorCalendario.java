...
public class GerenciadorCalendario <A,T,L,U>{
	 ...
	 * capacidade e um local. A turma no momento de sua criação tem de estar com capacidade vazia (nenhum usuário).
	 * Os usuários são adicionados posteriormente. Verifica se a atividade pode 
	 ...
	 * false - se a turma não puder ser alocada 
	 */
	 ...
	 * capacidade. As turmas no momento de sua criação tem de estar com capacidade vazias (nenhum usuário).
	 * Os usuários são adicionados posteriormente. Verifica se as atividades podem 
	 * pertencer às salas, e se os horários são compativeis (conflito com outras atividades e horário
	 * de funcionamento).
	 * @return true - se todas as turmas podem ser alocadas com determinada atividade,
	 * no local e horário desejados  
	 * false - se as turmas não puderem ser alocadas 
	 */
	...
	/**
	 * Exibe as informações de todas as turmas pertencentes a um local. Exibe também
	 * os horários e ocorrências no calendário, como duração, ocorrência, quando termina, etc.
	 */
	...
	/**
	 * Exibe todas as informações de todas turmas de determinada atividade. 
	 * @param atividade - atividade para exibição de turmas
	 */
	...
	/**
	 * Exibe todas as informações de todas as turmas criadas, incluindo os locais,
	 ...
	 * novo dia e horário. Os usuários em conflito são removidos. Não é obrigatório
	 ...
	 * mensagem indicando a operação pode ser configurada no log, mas deve conter o número
	 ...
	 * livres. Primeiro exibe todos os campos da turma e exige confirmação por entrada
	 * do usuário para completar a operação.
	 ...
	 * tipo da atividade da turma. Se houver qualquer conflito não altera o local.
	 ...
	 *  (não está cheia), se o usuário não participa de uma outra turma no mesmo horário, e
	 *  se o usuário ja participa de duas turmas em um mesmo dia. Em caso de conflitos o usuário não é adicionado.  
	 ...
	 * turma naquele horário e libera a capacidade da turma para um novo usuário. Primeiro exibe todas as informações
	 * principais de usuário, incluindo outras turmas, atividades, horários e locais que ele frequenta e exige confirmação
	 * por entrada do usuário para completar operação.
